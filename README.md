[README.md](https://github.com/user-attachments/files/24234340/README.md)
...
- Docker — упаковка приложения и зависимостей в контейнеры  [Uploading R# 3 Практическая работа: Docker + PostgreSQL
